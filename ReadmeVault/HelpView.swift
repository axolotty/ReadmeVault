            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    HelpSection(title: "Ressources", icon: "link") {
                        VStack(spacing: 0) {
                            Link(destination: URL(string: "https://github.com/Axolotty/ReadmeVault")!) {
                                HStack {
                            ...
                            Divider().padding(.horizontal, 12)
                            Link(destination: URL(string: "https://github.com/Axolotty/ReadmeVault/releases")!) {
                                HStack {
                            ...
                            Divider().padding(.horizontal, 12)
                            Link(destination: URL(string: "https://github.com/Axolotty/ReadmeVault/issues")!) {
                                HStack {
